    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_table_ids', models.JSONField(blank=True, default=list, help_text='Optional legacy table IDs this manager can access.')),
                ...
                ('assigned_tables', models.ManyToManyField(blank=True, help_text='Tables this manager can manage. Empty = all tables in the organisation.', related_name='assigned_managers', to='tables.table')),
                ('organisation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='managers', to='core.organisation')),
