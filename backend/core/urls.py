...
urlpatterns = [
    ...
    path('api/auth/pin-status/', csrf_exempt(views.api_pin_status), name='api_pin_status'),
    path('api/auth/login-pin/', csrf_exempt(views.api_login_pin), name='api_login_pin'),
    path('api/auth/create-pin/', csrf_exempt(views.api_create_pin), name='api_create_pin'),
